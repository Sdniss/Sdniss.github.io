...
2. Anthony suggested the following structure for each upcoming lesson:
   ...
   3. **Last part:** [Little Fox Chinese](https://www.youtube.com/@LittleFoxChinese) videos discussion. Priority is Mrs. Kelly's Class. For lesson 2, I will watch videos 1-3.
3. For myself, I decided to also review the words learned during the lesson by using flashcards. I started using Quizlet, but am now trying to develop something myself to have an easy 3-face system: Hanzi > Pinyin > English. Please check this out [here](https://sdniss.github.io/chinese/flashcards/). That way I prevent overly relying on Pinyin, as I now already feel this is a danger.
